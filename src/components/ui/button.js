export default function Button({ children, variant = "primary", className = "", disabled = false, ...props }) {
  const baseStyles =
    "inline-flex justify-center items-center focus:outline-none ring-0 rounded-[4px] px-6 py-3 text-sm font-medium uppercase tracking-wide relative overflow-hidden transition-all duration-200";
  const variants = {
    primary:
